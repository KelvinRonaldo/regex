const texto1 = 'dia diatonico diafragma medi wikipedia bom_dia melodia radial';
...
// borda é 'não \w', que é [^A-Za-z0-9_]... temos problemas com acentos, que são tratados nativamente como bordas
...
console.log(texto2.match(/([\wÀ-ü-]*)?dia([\wÀ-ü-]*)?/gi));